                    ...
                    <form action="" method="POST">
                        <table class="form">					
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" readonLy="readonly"
                                    value="<?php echo $result['address']; ?>" class="medium" />
                                </td>
                            </tr>
                            <tr>
                                <td>City</td>
                                <td>
                                    <input type="text" readonLy="readonly"
                                    value="<?php echo $result['city']; ?>" class="medium" />
                                </td>
                            </tr>
                            <tr>
                                <td>Zipcode</td>
                                <td>
                                    <input type="text" readonLy="readonly"
                                    value="<?php echo $result['zip']; ?>" class="medium" />
                                </td>
                            </tr>
                            <tr>
                                <td>Phone</td>
                                <td>
                                    <input type="text" readonLy="readonly"
                                    value="<?php echo $result['phone']; ?>" class="medium" />
                                </td>
                            </tr>
                            <tr>
                                <td>Email</td>
